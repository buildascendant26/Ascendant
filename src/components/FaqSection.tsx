...
const faqs = [
  ...
  { q: "What's the registration deadline?", a: "16th July 2026. Late registrations may not be accommodated due to limited capacity." },
  ...
  { q: "Is accommodation or transport provided for outstation teams?", a: "No transport provided." },
  { q: "Do all participants get certificates, or only winners?", a: "All participants get Spotify or YouTube Premium and everyone gets certificates." },
  { q: "How much is the prize pool?", a: "₹55,000+ worth of prizes." },
  { q: "How do I register for the event?", a: "Via the REGISTER NOW button on the homepage that links to the Entrar registration portal." },
